...
[![Plugin Version](https://img.shields.io/badge/Plugin-0.6.4-blue.svg)](https://github.com/krakend/claude-code-plugin)
[![MCP Server](https://img.shields.io/badge/MCP%20Server-0.6.3-green.svg)](https://github.com/krakend/mcp-server)
...
1. Download the KrakenD MCP Server v0.6.3 (fully offline-capable with embedded docs)
